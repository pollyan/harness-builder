...
**架构：** Scanner Skill 采用“确定性扫描核心 + 输出契约 + 人类报告模板”的结构。确定性脚本负责生成 JSON/YAML 事实源；Markdown 报告只解释事实源，不引入额外事实判断。首轮支持 RuoYi-Vue 与 eShopOnWeb 两类技术栈。
