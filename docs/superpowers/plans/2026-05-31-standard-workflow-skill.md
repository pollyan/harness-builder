...
- [ ] **Step 1: Write failing skill writer assertions**
...
- [ ] **Step 2: Run skill writer test and confirm failure**
...
- [ ] **Step 3: Add Standard Skill template and writer loop**
...
- [ ] **Step 4: Run skill writer test and confirm pass**
...
- [ ] **Step 3: Extend schema defaults and runtime contract enum**
...
- [ ] **Step 1: Write failing init and benchmark assertions**
...
- [ ] **Step 3: Update benchmark required files and content check**
...
- [ ] **Step 4: Run focused integration tests and confirm pass**
